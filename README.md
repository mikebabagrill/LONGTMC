[1.21.11 Update Changelog - PID00.md](https://github.com/user-attachments/files/29036290/1.21.11.Update.Changelog.-.PID00.md)
...
- Added a Screenshots channel
- Added a tutorials channel
...
- Server PC is able to be booted over the network
...
![[1e7feae8a88a5220c1d35dd024df1310fad635ab.png]]

- Photo Mode similar to Console edition photo mode
![[2026-06-16_21.18.55.png]]
![[2026-06-16_19.30.17.png]]

- Elytra Trims are now available
- Swords now hit through tall grass
- Colored Item Frames
- Custom Paintings
- Torch Flowers now glow
- Many QOL Horse Improvements
- Nautilus & Happy Ghast can be called with copper horns
- ItemsDisplayed for valuable items
- Litematica built in
- Pick Up Notifier tells you what items you are picking up
- Book GUI is more functional
...
- Wandering traders sell mini-blocks
- AFK player show on TAB menu
- Ender Dragon Drops elytra now
- Creepers have a 50% chance to explode into confetti and not grief 
- Right-Click Enchantment table with an Empty bottle to bottle levels
- Armor stand statues, use `/trigger as_help`
- Shulkers Drop double shells
- Husks Drop Sand
- Paintings can be selected inside a stonecutter
...
- Don't worry nothing of any importance will be reset (only in the overworld)
...
- Main Video Settings has been overhauled
- Resource Pack Menu Redone
...
- Animated campfire icons
- Twinkling Stars
- HD End Flash
- Variated Bookshelves
- Variated Jack O' Lanterns
- Bushes offset
- Peace N' Quiet
- Unique Painting Textures
- Different Stems
- Age 25 Kelp
- Music Disc Redstone level preview
- Brewing Guide
- Note block Visuals
- Spinning skull painting
- Soyjak vault
- Misc. Fixes
...
- Lantern Models improved


# Future Planning and Goals
![[Future.png]]
**Future Plans (Lithium Mining Reborn V2)
- Custom Music discs are making a comeback!
- Dynamic MOTD Swapping
- Discord Bot integration
- Prism Launcher instance for shaders!
- Custom Rotating Splash Text
- Overhaul Hall of Members Channel
